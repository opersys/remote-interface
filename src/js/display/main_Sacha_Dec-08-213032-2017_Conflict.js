...
require("../common/window.js");
require("../common/display_socket.js");
require("../common/comm_socket.js");
...
DisplayWindow.prototype._onCommSocketClosed = function () {
    console.log("'comm' socket closed");
};
